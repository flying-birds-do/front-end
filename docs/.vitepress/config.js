    ...
    sidebar: [
      ...
      },
      {
        ...
        { text: 'vue自带指令', link: '/vue3/1.3' },
          ...
          { text: 'Vuex', link: '/vue3/2.5' },
           { text: 'pinia', link: '/vue3/2.6' },
        ],
      },
        {
        text: '小程序',
        collapsible: true,
        items: [{ text: '微信小程序', link: '/smallProgram/1.1' },
          { text: 'uniapp', link: '/smallProgram/1.2' },
          { text: 'taro', link: '/smallProgram/1.3' },
          { text: '实战', link: '/smallProgram/1.4' },
        ],
      },
      {
        text: 'typeScript',
        collapsible: true,
        items: [{ text: '基础类型', link: '/typescript/1.1' },
          { text: '变量声明', link: '/typescript/1.2' },
          { text: '接口', link: '/typescript/1.3' },
          { text: '类', link: '/typescript/1.4' },
          { text: '泛型', link: '/typescript/1.5' }
        ],
      },
      {
        text: '数据结构',
